...
/**
 * ClassName: WebLogAspect.java <br>
 *
 * @author AlfredOrlando <br>
 * <p>
 * Created: 2024-04-27 03:29 <br> Description: 日志切面 <br>
 * <p>
 * Modification History: <br> - 2024/4/27 AlfredOrlando 日志切面 <br>
 */
@Component
@Aspect
@Order(1)
 ...
 */
     ...
     * 1 定义切入点
     */
    @Pointcut("execution(* cn.l13z.controller.*.*(..))") // controller 包里面所有类，类里面的所有方法 都有该切面
    public void webLog() {
    }
